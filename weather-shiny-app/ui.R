        ...
        mainPanel(
                tabsetPanel(
                        ...
                        tabPanel("Documentation",
                                ...
                                hr(),
                                 p('The data used by this app is a cleaned and tidy data set of severe weather events in the US since 1950 evaluated from both financial and health impact cumed for each month of the year, each state and event type. Initial data is from the NOAA Storm Database:'),
                                a('http://rpubs.com/longwei66/87696', href = 'http://rpubs.com/longwei66/87696'), 
                                hr(),
                                h3('More documentation :'),
                                p('A presentation of this app is available on Rpubs : '),
                                a('http://rpubs.com/longwei66/swa', href = 'http://rpubs.com/longwei66/swa'),
                                hr(),
                                h3('Source code'),
                                p('The source code of this app is available on github :'),
                                a('https://github.com/longwei66/severe-weather-usa-app/tree/master/weather-shiny-app', href = "https://github.com/longwei66/severe-weather-usa-app/tree/master/weather-shiny-app")
                        )
                )
        )
))